...
const Bio = () => {
  return (
    <div className="bio">
      ...
      <p>
        Interested in exploring data with code, building systems from scratch,
        and how humans use technology. Also likes phone photography,
        running+biking, magazines+zines, clothes, and music.
      </p>
      <p>
